(() => {
  ...
  const EN = {
    ...
    "nav.infra": "Infrastructure", "nav.projects": "Projects", "nav.pm": "Postmortems", "nav.stack": "Stack", "nav.contact": "Contact",
    "hero.eyebrow": "Open to offers · DevOps / MLOps",
    ...
    "p3.h": "LLM systems", "p3.p": "Models where they help, deterministic code where precision matters.",
    "p3.l1": "Circuit breaker and cost-aware routing", "p3.l2": "Eval harness: invariants and baseline in CI", "p3.l3": "RAG, LangGraph with a human in the loop, agent swarm",
    ...
    "dg.ws": "WORKSTATION · WINDOWS", "dg.obs": "stream recordings", "dg.users": "Users", "dg.users2": "Katch Telegram bot",
    ...
    "st.rule": "The rule: a technology goes in the first row only if I can talk for three minutes about what broke with it and how I fixed it.",
  ...
  const PROJECTS = [
    ...
    },
    {
      ...
      ru: { t: "manga-shorts", d: "Видеообзоры с vision-моделью: ~8K токенов на главу за счёт сеток превью, таймлайн по пословным таймкодам начитки." },
      en: { t: "manga-shorts", d: "Video reviews driven by a vision model: ~8K tokens per chapter via thumbnail grids, timeline aligned to word timestamps of the voice-over." },
      m: [["~8K", { ru: "токенов / глава", en: "tokens / chapter" }]],
      s: ["vision LLM", "whisper", "ffmpeg"],
    },
    {
    ...
    {
      slug: "vtube-acmt", cat: ["ml", "app"], tag: "ml",
      ru: { t: "Vtube ACMT", d: "Контрибьюции через PR: авториг VTuber-модели по 3D-голове, GPU-замеры на сервере, пайплайн на Prefect, лицензионная разведка." },
      en: { t: "Vtube ACMT", d: "Contributions via PRs: VTuber auto-rig from a 3D head, GPU benchmarks on the server, a Prefect pipeline, licensing research." },
      m: [["58", { ru: "коммитов", en: "commits" }]],
      s: ["PyTorch", "Docker", "Prefect", "Inochi2D"],
    },
    {
